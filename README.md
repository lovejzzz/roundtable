...
2. Codex and Claude alternate turns, inspecting the same project and reading the same shared transcript.
3. Add a steering note at any time. It is added to the transcript before the next agent turn.
4. Stop the discussion whenever you want.
